...
>
    ...
    <button @click="open = !open" class="text-blue-600 hover:underline text-sm font-medium mt-2" x-text="open ? '{{ $data['hide_text'] ?? 'Show less' }}' : '{{ $data['show_text'] ?? 'Show more' }}'"></button>
</div>
