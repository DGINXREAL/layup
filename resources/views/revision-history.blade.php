<div class="space-y-4">
    @if($revisions->isEmpty())
        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <p class="text-sm">No revision history available</p>
        </div>
    @else
        <div class="space-y-3">
            @foreach($revisions as $revision)
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-750 transition">
                    ...
                    <button
                        ...
                        onclick="if(!confirm('Are you sure you want to restore this revision? This will replace the current page content.')) { event.stopPropagation(); return false; }"
                    >
