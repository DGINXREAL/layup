...
it('getFormSchema() returns 2 tabs (Design + Advanced, no Content)', function () {
...
it('getDesignFormSchema() includes align_self and overflow fields', function () {
