...
it('builds section styles with background image', function () {
...
it('adds parallax attachment for background image', function () {
...
it('builds section styles with min height', function () {
    $styles = Section::buildSectionStyles(['min_height' => '100vh']);
    expect($styles)->toContain('min-height: 100vh');
});

it('returns empty string for empty settings', function () {
